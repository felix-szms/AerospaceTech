    ...
    nav: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: '🌡️ 大气参数计算器', link: '/tools/atmosphere' },
...
function getToolsSidebar() {
  return [
    ...
    },
    {
      ...
      collapsed: false,
      items: [
        { text: 'FoilSim 翼型实验室', link: '/tools/guide-foilsim' },
        { text: 'OpenRocket 切换中文', link: '/tools/guide-openrocket' },
        { text: 'NASA Eyes / Worldview', link: '/tools/guide-nasa-eyes' }
      ]
    },
    {
      text: '🧰 教学支持',
      collapsed: false,
      items: [
        { text: '🔗 课前链接自检', link: '/tools/link-check' }
      ]
    }
  ]
}
